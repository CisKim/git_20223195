...
|매크로 사용하기: 1.특정 문자에 저장한 매크로 실행 @[저장한 매크로 문자] 2.매크로 반복실행 반복횟수@[저장한 매크로 문자] 3.마지막에 수행한 매크로 실행 @@ |![image](https://user-images.githubusercontent.com/106826719/172033079-515fe902-c331-4562-8ccd-7d7faf9a59fa.png)|
