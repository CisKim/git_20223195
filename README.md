...
**"VIM 에디터에서 매크로(macro) 사용방법"**
---
* 매크로 사용방법
* 1. 매크로(macro) 시작 =q[name]
* 2. 매크로(macro) 입력
* 3. 매크로 종료=q
* 4. 매크로 실행 = @[name]
...
|매크로 사용법|사진|
|:---:|---|
|매크로 저장하기: q[저장할 매크로 문자] {qa -> 매크로 작성 -> q}|![image](https://user-images.githubusercontent.com/106826719/172033063-4517979c-6623-4072-9a4b-33c313604a37.png)|
|매크로 사용하기: 1.특정 문자에 저장한 매크로 실행 @[저장한 매크로 문자] 2.매크로 반복실행 반복횟수@[저장한 매크로 문자] 3.마지막에 수행한 매크로 실행 후 @@ |![image](https://user-images.githubusercontent.com/106826719/172033079-515fe902-c331-4562-8ccd-7d7faf9a59fa.png)|
|파일에 저장하기(재사용): 1. 현재 편집중 내용을 저장 후 ~/vlmrc를 열기(:e 또는 :r) :w, :e ~/.vimrc 2. inset모드 전환 후 저장할 매크로 이름을 변수로 하여 사용한 매크로 저장하기 i/a , let @[변수명]='ctrl+r ctrl+r [마지막사용 매크로 문자]' 다음 :wq! 또는 x |![image](https://user-images.githubusercontent.com/106826719/172033163-7d9da873-2e82-419c-8e59-8649c471290c.png)|

* :u = 작업 되돌리기로 vim 매크로를 통하여 소스수정이나 추가할 때 매크로 기능을 잘 활용하면 시간을 많이 줄일 수 있다.
